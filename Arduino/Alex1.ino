...
// enumerates the different movement states
typedef enum
{
  STOP = 0,
  FORWARD = 1,
...
// right encoders for moving forward and backward
...
//Variables to keep track of whether we have moved a commmanded distance
...
void leftISR()
{
  ...
  //leftTicks++;
  //Serial.print("LEFT: ");
  //Serial.println(leftFowardTicks);
}
...
void handleCommand(TPacket *command)
{
  switch (command->command)
  {
    ...
    case COMMAND_CLEAR_STATS:
      sendOK();
      clearOneCounter(command->params[0]); //parameter "which" in clearOneCounter is not used??
      break;
    default:
      sendBadCommand();
  }
